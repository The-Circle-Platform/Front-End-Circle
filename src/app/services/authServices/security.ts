...
export class securityService {
    ...
    sign(plaintext: string): string | false {
        ...
        // @ts-ignore
        var signature = this.userCrypto.sign('[{"Id":1,"UserName":"Jascha","IsOnline":false,"UserChatMessages":null,"StreamChatMessages":null,"CurrentWatchList":null}]', CryptoJS.SHA256, "sha256");
